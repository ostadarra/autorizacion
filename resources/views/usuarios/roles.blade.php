    ...
    <div class="card">
                    ...
                    <tr>
                       ...
                       <td>
                        <div class="d-flex align-items-center">  
                                <a href="{{ route('roles.edit', $rol->id) }}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Edit">
                                    <i class="fa fa-lg fa-fw fa-pen"></i>
                                </a>
                                <form action="{{ route('roles.destroy', $rol) }}" method="post" class="formEliminar">
                                    @csrf   
                                    @method('delete')
                                    {!!$btnDelete!!}
                                </form>
        ...
        <x-adminlte-modal id="modalPurple" title="Nuevo Rol" theme="primary"
            ...
            <form action="{{ route('roles.store') }}" method="post">
                @csrf
                <div class="row">
                    <x-adminlte-input name="name" label="Rol" placeholder="Nombre del rol"
